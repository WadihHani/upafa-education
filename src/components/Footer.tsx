    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <EditableText
              ...
              fallback="جامعة أفريقيا الفرنسية العربية الافتراضية (UPAFA Syria) تسعى لتقديم تعليم عالٍ نوعي يجمع بين الأصالة والمعاصرة عبر منصات التعليم عن بعد."
              as="p"
        ...
        <div className="mt-10 pt-6 border-t border-primary-foreground/15 text-center text-xs text-primary-foreground/50">
          © {new Date().getFullYear()} {get("university_name", "جامعة أفريقيا الفرنسية العربية الافتراضية")}. جميع الحقوق محفوظة.
        </div>
      </div>
    </footer>
  );
