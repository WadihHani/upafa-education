...
const events = [
  {
    title: "ندوة علمية: مناهج البحث في العلوم الشرعية",
    date: "قريباً",
    desc: "ندوة أكاديمية تناقش أحدث مناهج البحث العلمي في الدراسات الشرعية والإسلامية مع نخبة من الأساتذة والباحثين.",
  },
  {
    title: "مؤتمر التعليم عن بعد في العالم العربي",
    date: "قريباً",
    desc: "مؤتمر دولي يجمع خبراء التعليم الإلكتروني لمناقشة التحديات والفرص في منطقتنا العربية.",
  },
  {
    title: "محاضرات أكاديمية دورية",
    date: "مستمر",
    desc: "سلسلة محاضرات أسبوعية عبر منصة زووم في مختلف التخصصات الأكاديمية المتاحة.",
  },
];
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {events.map((event, i) => (
            <div
              key={i}
              className={`bg-card rounded-lg p-6 border shadow-sm hover:shadow-md transition-all duration-500 hover:-translate-y-1 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"
              }`}
              style={{
