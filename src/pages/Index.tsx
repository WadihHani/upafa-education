...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Seo
        title="جامعة أفريقيا الفرنسية العربية الافتراضية | UPAFA Syria – الموقع الرسمي"
        description="الموقع الرسمي لجامعة أفريقيا الفرنسية العربية الافتراضية (UPAFA Syria) في دمشق. تقدّم جامعة أفريقيا الفرنسية العربية الافتراضية برامج بكالوريوس وماجستير ودكتوراه معتمدة بنظام التعليم عن بعد."
        path="/"
      />
      <EditModeBar />
      <AnnouncementBar />
