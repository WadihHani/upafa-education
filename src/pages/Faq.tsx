...
const faqs = [
  ...
  },
  {
    ...
    a: "تمنح الجامعة شهادات البكالوريوس والماجستير والدكتوراه في مختلف الكليات، وجميعها معتمدة من جامعة أفريقيا الفرنسية العربية الافتراضية في مالي.",
  },
  {
  ...
  return (
    <>
      <Seo
        ...
        description="أجوبة على الأسئلة المتكررة حول التسجيل، الشهادات، الاعتراف الدولي، طرق الدراسة، والمنح في جامعة UPAFA."
        path="/faq"
        jsonLd={faqJsonLd}
      />
