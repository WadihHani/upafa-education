...
export const MOFADLA_DEFAULTS: Record<string, string> = {
  ...
  mofadla_cta_programs: "عرض الأقسام المتاحة",
  ...
  mofadla_dl_subtitle:
    "حمّل الملفات التالية للاطلاع على إجراءات القيد وجداول الأقسام بشكل تفصيلي.",
  ...
  mofadla_prog_badge: "الأقسام المتاحة",
  mofadla_prog_title: "اختصاصات مفاضلة صيف 2026",
  mofadla_prog_subtitle:
    "اطّلع على الأقسام المفتوحة للتقديم وعدد المقاعد والحدّ الأدنى للقبول.",
